      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <button className="bg-[#f4f3ee] text-[#c15f3c] px-6 py-2 rounded-lg hover:bg-white transition-colors duration-200 font-medium text-base" style={{ fontFamily: 'var(--font-lora)' }}>
              Join Club
            </button>
          </nav>
