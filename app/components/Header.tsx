            ...
            >
              <div className="px-2 pt-2 pb-3 space-y-1 bg-[var(--theme-card-bg)] backdrop-blur-sm border-t border-[var(--theme-card-border)] rounded-2xl">
                {navigationItems.map((item) => {
                  ...
                  const baseClasses = "flex px-3 py-4 transition-all duration-200 font-medium text-base font-sans rounded-lg min-h-[48px] items-center touch-manipulation";

                  const variantClasses = isDefault
                    ? "text-[var(--theme-text-primary)] hover:text-[var(--theme-text-accent)] hover:bg-[var(--theme-text-accent)]/10"
                    : isPrimary
                    ? "relative z-20 bg-[var(--theme-button-bg)] text-[var(--theme-button-text)] hover:bg-[var(--theme-button-hover-bg)] hover:text-[var(--theme-button-hover-text)] border border-[var(--theme-button-border)] hover:border-[var(--theme-button-hover-border)]"
                    : "relative z-20 bg-[var(--theme-button-alternate-bg)] text-[var(--theme-button-alternate-text)] hover:bg-[var(--theme-button-hover-bg)] hover:text-[var(--theme-button-hover-text)] border border-[var(--theme-button-alternate-border)] hover:border-[var(--theme-button-hover-border)]";
                  ...
                  return (
                    <motion.div key={item.href} variants={mobileItemVariants}>
                      <Link
                        ...
                        data-umami-event={item.umamiEvent?.replace("Nav -", "Mobile Nav -").replace("Header -", "Mobile Nav -")}
                      >
                        {item.label}
                      </Link>
                    </motion.div>
