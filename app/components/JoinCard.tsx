...
export default function JoinCard({
  ...
  return (
    <div className={`w-full rounded-2xl bg-[var(--theme-card-bg)] border-2 border-[var(--theme-card-border)] shadow-sm p-4 sm:p-6 ${className}`}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
        ...
        <Link
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex w-full items-center justify-center rounded-xl border-2 border-[var(--theme-button-text)] bg-[var(--theme-card-bg)] text-[var(--theme-text-dark)]/70 px-4 py-3 text-sm sm:text-base font-semibold hover:bg-[var(--theme-button-text)] hover:text-[var(--theme-card-bg)] hover:scale-105 hover:shadow-lg hover:border-[var(--theme-button-text)] transition-all duration-300 ease-in-out min-h-[40px] touch-manipulation"
        >
