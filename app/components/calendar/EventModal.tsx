      ...
      <div className="relative bg-white border border-gray-200 rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-hidden transform transition-all duration-300 ease-out">
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-5">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              className="text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-full p-2 transition-all duration-200 ease-in-out flex-shrink-0"
          ...
          {event.htmlLink && (
            <div className="pt-2">
              <a
                ...
                className="inline-flex items-center space-x-2 text-orange-600 hover:text-orange-800 transition-colors text-sm font-medium"
              >
